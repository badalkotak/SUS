...
.table-striped {background-color: #ffffff; padding: 5 !important;}
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="#"><i class="fa fa-edit"></i> <span>Edit Questions</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <form action="add_question.php" role="form" method="post">
  <div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <?php
    include("dbcon.php");
    $i=0;
    $get_question=mysqli_query($con,"SELECT question FROM Custom_questions WHERE workshop_id='$w_id'");
    if($q_row=mysqli_fetch_array($get_question))
    {
    ...
    while($quest_row=mysqli_fetch_array($get_questions))
    {
      ...
      echo '<div class="form-group">';
        echo "<h4><label for=comment>Question ".$i.":</label></h4>";
        echo "<textarea class='form-control' rows='4' id='comment' name=$i>$quest</textarea>";
      echo '</div><br>';
    }
  }
  else
  {
   ...
   {
     echo '<div class="form-group">';
  echo "<h4><label for=comment>Question ".($i+1).":</label></h4>";
  echo "<textarea class='form-control' rows='4' id='comment' name=$i></textarea>";
echo '</div><br>';
 }
  }
//    
...
<? echo "<button type=submit class='btn btn-success' name=id value='$w_id'>Done</button><br><br>" ?>
</form>
        </section><!-- /.content -->
      </div><!-- /.content-wrapper -->
      <!-- Main Footer -->
