      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="course.php"><i class="fa fa-plus"></i> <span>Add Workshop</span></a></li>
          </ul><!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
              </aside>
...
<? echo "<select name='menu1' onchange='showForm(this.value)'>" ?>
...
function showForm(str) {
  var xhttp;    
  if (str == "") {
    document.getElementById("txtHint").innerHTML = "Select Workshop..";
    return;
  }
  ...
  xhttp.open("GET", "view_form.php?id="+str+"&user="+document.getElementById('user').value, true);
  xhttp.send();
}
</script>
