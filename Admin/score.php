...
{
	echo "<script>alert('Thank you! Your score has been saved!');window.location.href='form.php';</script>";
}

else
{
	echo "<script>alert('Could not save your score! Something went wrong');window.location.href='form.php';</script>";
}
}
