      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="#"><i class="fa fa-gears"></i> <span>All Descriptions</span></a></li>
            <li><a href="question_filter.php"><i class="fa fa-gears"></i> <span>Question Wise Desp.</span></a></li>
            <li><a href="view_score.php"><i class="fa fa-gears"></i> <span>All Scores</span></a></li>
          </ul><!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
              </aside>
...
<tbody>';
        ...
        $date=$user_row['date'];
        $idd=$user_row['idd'];
        $workshop_name=mysqli_query($con,"SELECT name FROM Workshop WHERE id='$idd'");
