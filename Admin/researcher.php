...
<?php
          include("dbcon.php");
          $check=mysqli_query($con,"SELECT COUNT(id) FROM `Researcher`");
...
echo "<tbody>";
$i=0;
$result = mysqli_query($con,"SELECT * FROM `Researcher`");
         ...
         <div class="col-md-3">
              <div class="box box-default collapsed-box box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title">Add Researcher</h3>
                  <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i></button>
                  </div><!-- /.box-tools -->
                </div><!-- /.box-header -->
                <div class="box-body">
                  <form action=add_researcher.php name="addForm" role="form" method="post" onsubmit="return validateEmail();">
...
<? echo "<button type=submit class='btn btn-success' name=br value='$b'>Add</button>";?>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><br><br><br><!-- /.col -->
        </section><!-- /.content -->
